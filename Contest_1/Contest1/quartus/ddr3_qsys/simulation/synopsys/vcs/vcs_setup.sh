...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv \
  $QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_router_002.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0_router.sv \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_c0.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0.v \
  $QSYS_SIMDIR/submodules/altera_mem_if_sequencer_rst.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_router.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_s0_mm_interconnect_0_rsp_mux.sv \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_clock_pair_generator.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_read_valid_selector.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_addr_cmd_datapath.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_reset_m10.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_memphy_m10.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_dqdqs_pads_m10.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_reset_sync.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_fr_cycle_shifter.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_read_datapath_m10.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_write_datapath_m10.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_simple_ddio_out_m10.sv \
  $QSYS_SIMDIR/submodules/max10emif_dcfifo.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_iss_probe.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_addr_cmd_pads_m10.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0_flop_mem.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_p0.sv \
  $QSYS_SIMDIR/submodules/altera_gpio_lite.sv \
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller_pll0.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/ddr3_qsys_mm_interconnect_0.v \
  ...
  $QSYS_SIMDIR/submodules/ddr3_qsys_ddr3_controller.v \
  $QSYS_SIMDIR/ddr3_qsys.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
