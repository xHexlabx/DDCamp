...
(* altera_attribute = "-name IP_TOOL_NAME altera_mem_if_nextgen_ddr3_controller_core; -name IP_TOOL_VERSION 25.1; -name FITTER_ADJUST_HC_SHORT_PATH_GUARDBAND 100" *)
