...
lappend arg_list "--component-param=SEQUENCER_VERSION=25.1"
...
catch { eval [concat [list exec "/home/hextex/altera_standard/25.1std/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
